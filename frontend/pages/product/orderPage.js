                    ...
                    <form>
                        <div className="max-w-2xl mx-auto px-4 lg:max-w-none lg:px-0">
                            ...
                            <div className="mt-10 flex justify-end pt-6 border-t border-gray-200">
                                ...
                                <button
                                    type="submit"
                                    className="ml-3 bg-indigo-600 border border-transparent rounded-md shadow-sm py-2 px-4 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500"
                                >
                                    Pay now
                                </button>
                            </div>
