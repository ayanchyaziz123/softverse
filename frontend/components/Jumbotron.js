...
const Jumbotron = () => {
    return (
        <>
            <div class="max-w-7xl bg-teal-900 shadow-2xl rounded-sm mx-auto text-center py-12 mt-4">
                <h2 class="text-3xl leading-9 font-bold tracking-tight text-white sm:text-4xl sm:leading-10">
                    Sofyverse.store
                </h2>
                <p className='text-white mt-5'>This is a website for buy software and order software!</p>
